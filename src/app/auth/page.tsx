    ...
    <GlassCard className="p-8">
      ...
      <div className="mt-6 space-y-3">
        <button
          ...
          disabled={loading}
          className="glass flex w-full items-center justify-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold transition hover:bg-slate-100 disabled:opacity-50 dark:hover:bg-white/10"
          style={{ color: 'inherit' }}
        >
          <svg 
            className="h-5 w-5 flex-shrink-0 dark:text-white" 
          ...
          <span className="dark:text-white" style={theme === 'light' ? { color: '#0f172a' } : undefined}>Continuer avec GitHub</span>
        </button>
        ...
        >
          ...
          <span className="dark:text-white" style={theme === 'light' ? { color: '#0f172a' } : undefined}>Continuer avec Google</span>
        </button>
      </div>
...
export default function AuthPage() {
  ...
  return (
    <section className="mx-auto min-h-screen max-w-md px-4 py-16">
      <button
        onClick={() => router.push('/')}
        className="mb-6 flex items-center gap-2 rounded-xl border-2 bg-white px-4 py-2 text-sm font-bold transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10"
        style={theme === 'light' ? { borderColor: '#cbd5e1', color: '#0f172a' } : undefined}
      >
        <svg 
        ...
        <span className="dark:text-white" style={theme === 'light' ? { color: '#0f172a' } : undefined}>{t.auth.backHome}</span>
      </button>
